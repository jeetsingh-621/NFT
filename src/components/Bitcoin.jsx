  ...
  return (
    <div className='px-4  flex flex-col md:flex-row w-full py-4 md:px-10 md:py-10'>
        <div className='w-full h-full flex flex-col md:flex-row relative'>
            <span className='md:w-[60%] w-full h-full hidden   md:h-[30rem] xl:ms-5 bg-purple md:inline-block  blur-[80px]'></span>
            <img className='lg:max-w-[400px] max-w-[300px] mx-auto lg:mx-0 md:absolute md:top-0  w-full ' src={rectangle} alt="" />
        </div>
        <div className='w-full mt-12 md:mt-0 h-full '>
            ...
            <h4 className='text-sm'>created by  <span className='text-light-purple'> Jonathon Borba</span></h4>
            <div className='w-full justify-between  md:justify-start flex mt-10 '>
                <div className="left text-xs md:text-md pr-2 md:w-[30%]  ">
                    <h5 className='text-sm'>Current Bid</h5>
                    <h1 className='md:text-2xl font-[500] py-1'>1.09 ETH</h1>
                    <h6 className='text-xs'>$1,385</h6>
                </div> 
